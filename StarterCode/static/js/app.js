 ...
 const guageData = [
    {
      ...
      mode: "gauge+number",     
       ...
       bar: { color: "#f2e9e4" },
       steps: [
          { range: [0, 1], color: "#ecf4e6" },
          { range: [1, 2], color: "#dcecd0" },
          { range: [2, 3], color: "#c0dfa7" },
          { range: [3, 4], color: "#b4d897" },
          { range: [4, 5], color: "#7bc170" },
          { range: [5, 6], color: "#5fba50" },
          { range: [6, 7], color: "#24ba5c" },
          { range: [7, 8], color: "#1bb253" },
          { range: [8, 9], color: "#058b37" }
